...
[PaxtogeddonReaderV2](firmware/PaxtogeddonReaderV2) contains Daniel's improved version 2 code which supports both this PCB version and the protoboard design by Waz. It uses custom cards to configure the reader. Information on how to rewrite Paxton cards to use as the config cards can be found in [MAKE-CARDS.md](MAKE-CARDS.md)
